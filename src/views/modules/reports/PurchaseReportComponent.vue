    ...
    <v-app>
        <v-row>
            ...
            <v-col class="text-left px-2 mt-2" cols="12">
                <v-card-title>
                    <v-row>
                        <v-col><h2>Purchase Report</h2></v-col>
                        <v-spacer></v-spacer>
            ...
            <div style="display: none;">
                <table id="div_logo">
                    <tbody>
                        ...
                        <tr>
                            <td><p><span style="font-size: 18px; font-weight: bold;">PURCHASE REPORT</span></p></td>
                        </tr>
                    </tbody>
                </table>
                <table id="item_table">
...
export default {
    ...
    data() {
        return {
            ...
            headers:[
                ...
                { text: 'Purchase #', value: 'purchase_num',class:'grey lighten-2' },
                { text: 'Supplier', value: 'supplier.supplier_name',class:'grey lighten-2' },
    ...
    methods: {
        getAll(){
            ...
            axios.post(`${process.env.VUE_APP_HOST_API}/api/get-all-purchase-report`,payload).then(response=>{
        ...
        exportToExcel(){
            ...
            worksheet.columns = [
                ...
                { header: 'Purchase #', key: 'purchase_num' },
                { header: 'Supplier', key: 'supplier_text' },
            ...
            let exportName = `Purchase Report - ${this.date_from} to ${this.date_to}`
            that.loading = false
